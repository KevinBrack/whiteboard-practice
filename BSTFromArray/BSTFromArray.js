...
function isBinarySearchTree(root) {
  const nodeAndBoudsStack = [];
  nodeAndBoudsStack.push({
    node: root,
    lowerBound: -Infinity,
    upperBound: Infinity
  });

  while (nodeAndBoudsStack.length) {
    const nodeAndBounds = nodeAndBoudsStack.pop();
...
// Helper function to check the max height of BST
...
module.exports = { createMinimalBST, isBinarySearchTree, maxDepth };
