...
*/
function minJumpsRecursive(arr, start = 0, end = arr.length - 1) {
  ...
  for (let i = start + 1; i <= end && i <= start + arr[start]; i++) {
    const jumps = minJumpsRecursive(arr, i, end);
...
console.log("\nRECURSIVE");
console.log(minJumpsRecursive([1, 3, 5, 8, 9, 2, 6, 7, 6, 8, 9])); // should print 3
console.log(minJumpsRecursive([1, 3, 6, 1, 0, 9])); // should print 3
console.log(minJumpsRecursive([2, 0, 0, 5, 8, 1, 7, 4, 9, 12, 1])); // should print Infinity
console.log(minJumpsRecursive([1, 3, 6, 3, 2, 3, 6, 8, 9, 5])); // should print 4
